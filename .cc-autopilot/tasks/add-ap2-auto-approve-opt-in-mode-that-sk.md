...
- `grep -nE "^AP2_AUTO_APPROVE" .cc-autopilot/env` — exit may be 0 or 1 depending on whether the operator has enabled the knob; this is informational. The auto-verify path is the next bullet.
